...
set my_verilog_files [list adder.v alu.v cla_4.v control.v decode.v dff.v execute.v fetch.v fulladder_1.v groupcla.v memory2c.syn.v memory.v proc.v register.v rf.v shifter_1.v shifter_2.v shifter_4.v shifter_8.v shifter.v writeBack.v EXMEM.v forwarding.v hazard.v IDEX.v IFID.v MEMWB.v rf_bypass.v  ]
